  ...
  return (
    <div className="p-6 flex flex-col flex-1">
      <div className="flex-1 max-md:text-center">
        ...
        <h3 className="font-light mt-4 flex items-center flex-wrap gap-1 max-md:justify-center">
      ...
      <div className="flex-none text-[0.7em] font-light w-full flex items-center justify-center mb-2">
